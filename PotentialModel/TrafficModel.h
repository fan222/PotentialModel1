...
public:
	...
	float LaneMarkCost(float s,float d,FrenetLaneMark &LaneMark);//车道线势场计算
	float DynamicLaneRightCost(float s,float d,SObstacle &ObsInfo,FrenetLaneMark &LaneMark,AutoVeh &veh);//动态车道占据势场
	float StaticLaneRightCost(float s,float d,SObstacle &ObsInfo,FrenetLaneMark &LaneMark,AutoVeh &veh);//静态车道占据势场
	float HumanCost(float s,float d, SObstacle &ObsInfo);//行人占据势场
